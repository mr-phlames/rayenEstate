                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li><a href="my_listings.php"><i class="ti-layout-sidebar-left"></i> My Listings</a>
                            </li>
                            <li><a href="#"><i class="ti-user"></i> Contact User</a></li>
                            <li class="active"><a href="#"><i class="ti-book"></i> Invoices</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            <div class="invoice-address">
                                                <h3>invoiced to</h3>
                                                <h5>Verdie Hintz</h5>
                                                <p>4494 Weekley Street, Accra, 78205 Madina</p>
                                                <p>Accra</p>
                                                <p>Ghana</p>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table table-bordered table-hover text-right">
                                            <thead>
                                                <tr class="text-capitalize">
                                                    ...
                                                    <th class="text-left" style="width: 45%; min-width: 130px;">
                                                        description</th>
                                                    <th>qty</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-left">Big Land</td>
                                                    <td>1</td>
                                                    <td>GH¢ 200000</td>
                                                    <td>GH¢ 4000</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-left">Beautiful House</td>
                                                    <td>2</td>
                                                    <td>GH¢ 50000</td>
                                                    <td>GH¢ 10000</td>
                                                </tr>
