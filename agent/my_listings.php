    ...
    <div class="page-container">
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active"><a href="my_listings.php"><i class="ti-layout-sidebar-left"></i> My Listings</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">My Listings</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.php">Home</a></li>
                                <li><span>My Listings</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown"><?php echo $_SESSION['username']; ?><i
                ...
                <div class="card-area">
                    <div class="row">
                        <?php 
                            ...
                            //  display listings for a  specific account
                            $query = "SELECT DISTINCT * FROM listings WHERE email = '$email'";
                            $listings = mysqli_query($connection, $query);
                            $rows = mysqli_num_rows($listings);
                                                ...
                                                <p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-xs-6">
                                                            ...
                                                            Land Size: '.$listing['land_dimensions'].'
                                                        </div>
                                                        <div class="col-md-6 col-xs-6">
                                                            '.$listing['bathrooms'].' bathrooms<br>
                                                            House Size: '.$listing['property_dimensions'].'
                                                        </div>
                                                    </div>
                                                </p>
                                                <br>
                                                <br>
                                                <a href="php/withdraw_listing.php?id='.$listing["id"].'" class="btn btn-danger btn-block">Withdraw Listing</a>
                                            </div>
                                        </div>
                                    </div>
                                ';
        ...
        <footer>
            <div class="footer-area">
                <p>©
                    <script>document.write(new Date().getFullYear());</script>. Mychi Darko</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
