		...
		<div class="container">
			...
			<div class="row featured_row">
				...
				<?php 
					...
					$query = "SELECT DISTINCT * FROM listings ORDER BY id DESC LIMIT 3";
									...
									<div class="listing">
										<div class="listing_image">
											<div class="listing_image_container">
												<img src="agent/uploads/'.$listing['img_name'].'" style="height: 300px; width: 100%;" alt="">
											</div>
										...
										<div class="listing_content">
											<div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
												...
												<a href="single.php?id='.$listing['id'].'">'.$listing['name'].'</a>
											</div>
											<div class="listing_info">
												<ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
													<li class="property_area d-flex flex-row align-items-center justify-content-start">
														<img src="images/icon_2.png" alt="">
														<span>'.$listing['property_dimensions'].'</span>
													</li>
